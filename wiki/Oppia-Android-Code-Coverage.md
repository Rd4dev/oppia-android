...
- [How to use the code coverage tool?](#how-to-use-the-code-coverage-tool)
    - [1. Continuous Itegration Checks on Pull Requests](#1-continuous-integration-checks-on-pull-requests)
        - [1.1 Understanding the CI Coverage Report](#11-understanding-the-ci-coverage-report)
    - [2. Local Command Line Interface Tools](#2-local-command-line-interface-cli-tools)
        - [2.1 Understanding the Html Reports](#21-understanding-the-ci-coverage-report)
